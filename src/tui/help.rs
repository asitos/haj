...
pub fn render_popup(f: &mut Frame) {
    ...
    let help_text = vec![
        Line::from(Span::styled("navigation", Style::default().fg(Color::Magenta).add_modifier(Modifier::BOLD))),
        ...
        Line::from(Span::styled("dashboard", Style::default().fg(Color::Magenta).add_modifier(Modifier::BOLD))),
        Line::from(Span::styled("─────────", Style::default().fg(Color::DarkGray))),
        format_bind("n", "news"),
        format_bind("u", "updates"),
        format_bind("t", "statistics"),
        format_bind("h", "history"),
        format_bind("g", "groups"),
        format_bind("o", "orphans"),
        format_bind("c", "cache cleaner"),
        Line::from(""),
        
        Line::from(Span::styled("global", Style::default().fg(Color::Magenta).add_modifier(Modifier::BOLD))),
        Line::from(Span::styled("──────", Style::default().fg(Color::DarkGray))),
